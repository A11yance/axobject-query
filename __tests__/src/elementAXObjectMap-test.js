...
describe('elementAXObjectMap', function () {
  describe('iteration', function () {
    ...
    it('should support the spread operator', function () {
      expect([...elementAXObjectMap].length).toEqual(69);
      expect([...elementAXObjectMap]).toEqual(
    ...
    it('should support one-by-one iteration withe the next method', function () {
  ...
  describe('content', function () {
    ...
    it('get()', function () {
      ...
      expect(elementAXObjectMap.get({"name": "summary"})).toEqual(["DisclosureTriangleRole"]);
    ...
    it('keys(), iteration', function() {
      expect(elementAXObjectMap.keys()).toEqual(
        expect.arrayContaining(
          [
            {"name": "abbr"},
            {"name": "article"},
            ...
            {"attributes": [{"name": "type", "value": "color"}], "name": "input"},
            {"name": "th"},
            {"name": "select"},
            {"attributes": [{"name": "type", "value": "date"}], "name": "input"},
            {"attributes": [{"name": "type", "value": "datetime"}], "name": "input"},
            {"name": "dfn"},
            {"name": "dd"},
            {"name": "dl"},
            {"name": "dt"},
            ...
            {"name": "h6"},
            {"name": "iframe"},
            {"attributes": [{"name": "usemap"}], "name": "img"},
            {"name": "img"},
            {"name": "input"},
            {"attributes": [{"name": "type", "value": "time"}], "name": "input"},
            {"name": "label"},
            {"name": "legend"},
            {"name": "br"},
    ...
    it('values(), iteration', function() {
      expect(elementAXObjectMap.values()).toEqual(
        expect.arrayContaining(
          [
            ["AbbrRole"],
            ["ArticleRole"],
            ...
            ["CaptionRole"],
            ["CellRole"],
            ["CheckBoxRole", "SwitchRole"],
            ["ColorWellRole"],
            ["ColumnHeaderRole"],
            ["ComboBoxRole", "ListBoxRole"],
            ["DateRole"],
            ["DateTimeRole"],
            ["DefinitionRole"],
            ...
            ["ImageMapRole"],
            ["ImageRole"],
            ["InlineTextBoxRole", "TextFieldRole"],
            ["InputTimeRole"],
            ["LabelRole"],
            ["LegendRole"],
            ["LineBreakRole"],

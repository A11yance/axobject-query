...
const entriesList = [
  ...
  ["DisclosureTriangleRole", {relatedConcepts: [{module: 'HTML',concept: {constraints: ['scoped to a details element',],name: 'summary',},},],type: 'widget',}],
...
test('AXObjectsMap', async (t) => {
  ...
  t.test('content', async (st) => {
    ...
    st.test('get()', async (s2t) => {
      ...
      s2t.deepEqual(AXObjectsMap.get("DisclosureTriangleRole"), {relatedConcepts: [{module: 'HTML',concept: {constraints: ['scoped to a details element',],name: 'summary',},},],type: 'widget',},);

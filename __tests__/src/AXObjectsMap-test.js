...
describe('AXObjectsMap', function () {
  describe('iteration', function () {
    ...
    it('should support the spread operator', function () {
      expect([...AXObjectsMap].length).toEqual(123);
      expect([...AXObjectsMap]).toEqual(
        expect.arrayContaining(
          [
            ...
            ["DisclosureTriangleRole", expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'summary',},},],type: 'widget',})],
  ...
  describe('content', function () {
    ...
    it('get()', function () {
      ...
      expect(AXObjectsMap.get("DisclosureTriangleRole")).toEqual(expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'summary',},},],type: 'widget',}),);
    ...
    it('keys(), iteration', function () {
      expect(AXObjectsMap.keys()).toEqual(
        expect.arrayContaining(
          [
            "AbbrRole",
            "AlertDialogRole",
    ...
    it('values(), iteration', function () {
      expect(AXObjectsMap.values()).toEqual(
        expect.arrayContaining(
          [
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'abbr',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'alertdialog',},},],type: 'window',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'alert',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'application',},},],type: 'window',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'article',},},{module: 'HTML',concept: {name: 'article',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'audio',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'banner',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'blockquote',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {attributes: [{name: 'aria-busy',value: 'true',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'button',},},{module: 'HTML',concept: {name: 'button',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'canvas',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'caption',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'cell',},},{module: 'ARIA',concept: {name: 'gridcell',},},{module: 'HTML',concept: {name: 'td',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'checkbox',},},{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'checkbox',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'color',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'columnheader',},},{module: 'HTML',concept: {name: 'th',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'combobox',},},{module: 'HTML',concept: {name: 'select',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'complementary',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'structureinfo',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'date',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'datetime',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'dfn',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'dd',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'dl',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'dt',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'details',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'dialog',},},{module: 'HTML',concept: {name: 'dialog',},},],type: 'window',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'directory',},},{module: 'HTML',concept: {name: 'dir',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'summary',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'div',},},],type: 'generic',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'document',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'embed',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'feed',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'figcaption',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'figure',},},{module: 'HTML',concept: {name: 'figure',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'footer',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'form',},},{module: 'HTML',concept: {name: 'form',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'grid',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'group',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'heading',},},{module: 'HTML',concept: {name: 'h1',},},{module: 'HTML',concept: {name: 'h2',},},{module: 'HTML',concept: {name: 'h3',},},{module: 'HTML',concept: {name: 'h4',},},{module: 'HTML',concept: {name: 'h5',},},{module: 'HTML',concept: {name: 'h6',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'window',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'iframe',},},],type: 'window',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'img',attributes: [{name: 'usemap',},],},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'img',},},{module: 'HTML',concept: {name: 'img',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'input',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'time',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'label',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'legend',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'br',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'link',},},{module: 'HTML',concept: {name: 'a',attributes: [{name: 'href',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'option',},},{module: 'HTML',concept: {name: 'option',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'listbox',},},{module: 'HTML',concept: {name: 'datalist',},},{module: 'HTML',concept: {name: 'select',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'listitem',},},{module: 'HTML',concept: {name: 'li',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'list',},},{module: 'HTML',concept: {name: 'ul',},},{module: 'HTML',concept: {name: 'ol',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'log',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'main',},},{module: 'HTML',concept: {name: 'main',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'mark',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'marquee',},},{module: 'HTML',concept: {name: 'marquee',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'math',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'menubar',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'menuitem',},},{module: 'HTML',concept: {name: 'menuitem',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'menuitemcheckbox',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'menuitemradio',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'menu',},},{module: 'HTML',concept: {name: 'menu',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'meter',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'navigation',},},{module: 'HTML',concept: {name: 'nav',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'none',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'note',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'p',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'pre',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'presentation',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'progressbar',},},{module: 'HTML',concept: {name: 'progress',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'radio',},},{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'radio',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'radiogroup',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'region',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'rowheader',},},{module: 'HTML',concept: {name: 'th',attributes: [{name: 'scope',value: 'row',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'row',},},{module: 'HTML',concept: {name: 'tr',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'ruby',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'scrollbar',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'search',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'searchbox',},},{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'search',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'slider',},},{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'range',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'spinbutton',},},{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'number',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'separator',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'status',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'switch',},},{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'checkbox',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'tablist',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'tab',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'table',},},{module: 'HTML',concept: {name: 'table',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'tablist',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'tabpanel',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'term',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'textbox',},},{module: 'HTML',concept: {name: 'input',},},{module: 'HTML',concept: {name: 'input',attributes: [{name: 'type',value: 'text',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'time',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'timer',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {attributes: [{name: 'aria-pressed',},],},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'toolbar',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'tree',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'treegrid',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'treeitem',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [{module: 'ARIA',concept: {name: 'tooltip',},},],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [{module: 'HTML',concept: {name: 'video',},},],type: 'widget',}),
            expect.objectContaining({relatedConcepts: [],type: 'structure',}),
            expect.objectContaining({relatedConcepts: [],type: 'window',}),
          ]
        ),

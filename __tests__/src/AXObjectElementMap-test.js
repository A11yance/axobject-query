...
test('AXObjectElementMap', async (t) => {
  ...
  t.test('content', async (st) => {
    ...
    st.test('get()', async (s2t) => {
      ...
      s2t.deepEqual(AXObjectElementMap.get("DisclosureTriangleRole"), [{"attributes": [{"name": "open", "value": "open"}], "constraints": ["scoped to a details element"], "name": "summary"}, {"attributes": [{"name": "aria-expanded"}], "constraints": ["scoped to a details element"], "name": "summary"}]);

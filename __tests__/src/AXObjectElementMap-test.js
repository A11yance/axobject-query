...
describe('AXObjectElementMap', function () {
  describe('iteration', function () {
    ...
    it('should support the spread operator', function () {
      expect([...AXObjectElementMap].length).toEqual(64);
      expect([...AXObjectElementMap]).toEqual(
  ...
  describe('content', function () {
    ...
    it('get()', function () {
      ...
      expect(AXObjectElementMap.get("DisclosureTriangleRole")).toEqual([{"name": "summary"}]);
    ...
    it('keys(), iteration', function() {
      expect(AXObjectElementMap.keys()).toEqual(
        expect.arrayContaining(
          [
            "AbbrRole",
            "ArticleRole",
    ...
    it('values(), iteration', function() {
      expect(AXObjectElementMap.values()).toEqual(
        expect.arrayContaining(
          [
            [{"name": "abbr"}],
            [{"name": "article"}],
            ...
            [{"attributes": [{"name": "type", "value": "checkbox"}], "name": "input"}],
            [{"name": "table"}],
            [{"name": "input"}, {"attributes": [{"name": "type", "value": "text"}], "name": "input"}],
            [{"name": "time"}],
            [{"name": "video"}],
          ]
        )
